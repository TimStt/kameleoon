...
import SearchTests from "@features/tests/search/ui/search-tests/search-input";
import { useSearchTests } from "@features/tests/search/model/use-search-tests";
import { NAME_SEARCH_PARAM } from "@features/tests/search/constants";
  ...
  return (
    <form className={styles.root}>
      ...
      <SearchTests
        ...
        classNameCount={styles.test_count}
      />
    </form>
  );
};
